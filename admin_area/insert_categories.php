...
if(isset($_POST['insert_cat'])){
  $category_titles=$_POST['cat_title'];
  //select data from database
  $select_query="select * from `categories` where category_title='$category_titles'";
  ...
  $sql="insert into `categories`(category_title) values('$category_titles')";
...
<form action="" method="post"  class="mb-2">
  ...
  <!--<button class="bg-info border-0 p-2 my-3">Insert categories</button>-->
